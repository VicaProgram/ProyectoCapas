...
return DArr.Instancia.Listar();
        ...
        public static Respuesta<bool> Ingresar(EArr_Det obj)
        {
            bool Respuesta = false;
            Respuesta = DArr_Det.Instancia.Ingresar(obj);
        ...
        {
            return DArr_Det.Instancia.ObtenerUltimoId(); //LLama el metodo
        }
    }
}
