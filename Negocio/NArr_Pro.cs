...
return DArr.Instancia.Listar();
        ...
        public static Respuesta<bool> Ingresar(EArr_Pro obj)
        {
            bool Respuesta = false;
            Respuesta = DArr_Pro.Instancia.Ingresar(obj);
        ...
        {
            return DArr_Pro.Instancia.ObtenerUltimoId(); //LLama el metodo
        }
    }
}
