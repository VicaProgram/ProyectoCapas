...
{
    public partial class PProv_Act : Form //Declara Form
    {
        public PProv_Act() //Inicializa
        {
            InitializeComponent();//Inicializa
            ApplyModernStyles(this.Controls);
        }

        ValidaRut Rut = new ValidaRut();//Declara objeto
        EProv Ent = new EProv();//Declara objeto
        NProv Neg = new NProv();//Declara objeto
        ...
        private void PProv_Act_Load(object sender, EventArgs e) //Evento
        {
        ...
        {
            if ((TextNomF.Text.Trim() != TextNomI.Text.Trim()) || (TextRutF.Text.Trim() != labelRtI.Text.Trim()) || (TextComIdeF.Text.Trim() != TextComIdeI.Text.Trim()) || (TextComI.Text.Trim() != TextComF.Text.Trim()) || (TextDireF.Text.Trim() != TextDireI.Text.Trim()) || (TextGirF.Text.Trim() != TextGirI.Text.Trim()) || (TextDesF.Text.Trim() != TextDesI.Text.Trim()) || (TextTelF.Text.Trim() != TextTelI.Text.Trim()) || (TextEmaF.Text.Trim() != TextEmaI.Text.Trim()))// Verifica si el campo de entrada no está vacío
            {
                ...
                LabelDes.Enabled = false;// Deshabilita el Label
            }
            else//Sino
            {
                ...
                LabelDes.Enabled = true;// Habilita el Label
            }
        }
        ...
        public void Cambio()//Declara metodo
        {
            ...
            TextDesF.Enabled = false;// Deshabilita el TextBox
            ButMod.Enabled = false;// Deshabilita el botón
        ...
        private void ButAnu_Click(object sender, EventArgs e)//Evento
        {
            ...
            TextDesF.Text = TextDesI.Text;//Le da el valor
            Cambio();//Llama metodo
        }
        ...
        private void ButMod_Click(object sender, EventArgs e)//Evento
        {
            ...
            Ent.IdProv = Convert.ToInt32(TextIdCli.Text); //Le da el valor
            ...
            Ent.Descr = TextDesF.Text;//Le da el valor
            if (res == DialogResult.Yes)//Verifica si el usuario seleccionó "Sí" en el cuadro de diálogo.
            {
                Respuesta<bool> resultado = NProv.Actualizar(Ent);//Llama metodo
                if (resultado.estado)//Verifica si el estado de la respuesta indica éxito
                {
                    ...
                    TextDesI.Text = TextDesF.Text;//Le da el valor
                }
                else//Sino
                {
        ...
        private void LabelDes_Click(object sender, EventArgs e)//Evento
        {
            TextDesF.Enabled = true;// Habilita el TextBox
        }

        private void TextDesF_TextChanged(object sender, EventArgs e)//Evento
        {
            Validar();//Llama el metodo
        }
    }
