...
{
    public partial class PProv_Ing : Form //Declara form
    {
        ValidaRut Rut = new ValidaRut();//Declara objeto
        EProv Ent = new EProv();//Declara objeto
        ...
        private void PProv_Ing_Load(object sender, EventArgs e) //Evento
        {
        ...
        private void TextRut_Leave(object sender, EventArgs e)//Evento texto
        {
        ...
        private void TextRut_TextChanged(object sender, EventArgs e)//Evento texto
        {
        ...
        private void TextNom_KeyPress(object sender, KeyPressEventArgs e)//Evento texto
        {
        ...
        private void TextNom_TextChanged(object sender, EventArgs e)//Evento texto
        {
        ...
        private void CBReg_SelectedIndexChanged(object sender, EventArgs e)//Evento combo
        {
        ...
        private void CBPro_SelectedIndexChanged(object sender, EventArgs e)//Evento combo
        {
        ...
        private void CBCom_SelectedIndexChanged(object sender, EventArgs e)//Evento combo
        {
        ...
        private void TextDire_TextChanged(object sender, EventArgs e)//Evento texto
        {
        ...
        private void TextTel_TextChanged(object sender, EventArgs e)//Evento texto
        {
        ...
        private void TextEma_TextChanged(object sender, EventArgs e)//Evento texto
        {
        ...
        private void TextGir_TextChanged(object sender, EventArgs e)//Evento texto
        {
            if (TextGir.Text.Trim() != "")// Verifica si el campo de entrada no está vacío
            {
                TextDescr.TabStop = true;//permite el enfoque con Tab
                TextGir.TabStop = false;//no permite el enfoque con Tab
            }
            else//Si no
            {
                TextDescr.TabStop = false;//no permite el enfoque con Tab
                TextGir.TabStop = true;//permite el enfoque con Tab
            }
            HabBotLim();//Llama metodo
            HabBotIng();//Llama metodo    
        ...
        private void TextDescr_TextChanged(object sender, EventArgs e)//Evento texto
        {
            if (TextDescr.Text.Trim() != "")// Verifica si el campo de entrada no está vacío
            {
                ButIng.TabStop = true;//permite el enfoque con Tab
                TextDescr.TabStop = false;//no permite el enfoque con Tab
            }
            else//Si no
            {
                ButIng.TabStop = false;//no permite el enfoque con Tab
                TextDescr.TabStop = true;//permite el enfoque con Tab
            }
            HabBotLim();//Llama metodo
            HabBotIng();//Llama metodo
        ...
        private void ButLim_Click(object sender, EventArgs e)//Evento boton
        {
            ...
            TextDescr.Clear();//Limpia el texto
        ...
        private void ButIng_Click(object sender, EventArgs e)//Evento boton
        {
            ...
            Ent.Descr = TextDescr.Text;//Le da el valor
            if (res == DialogResult.Yes)//Verifica si el usuario seleccionó "Sí" en el cuadro de diálogo.
            {
                Respuesta<bool> resultado = NProv.Ingresar(Ent);//Llama metodo
        ...
        private void ButVol_Click(object sender, EventArgs e)//Evento boton
        {
            this.Close();//Cierra la ventana
        }

        private void ButSal_Click(object sender, EventArgs e)//Evento boton
        {
